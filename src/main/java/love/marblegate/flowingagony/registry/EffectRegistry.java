...
public class EffectRegistry {
    ...
    public static final RegistryObject<Effect> cursed_hatred_effect = EFFECT.register("cursed_hatred", () -> new CursedHatredEffect());
    public static final RegistryObject<Effect> cursed_antipathy_effect = EFFECT.register("cursed_antipathy", () -> new CursedAntipathyEffect());
    public static final RegistryObject<Effect> extreme_hatred_effect = EFFECT.register("extreme_hatred", () -> new ExtremeHatredEffect());
    public static final RegistryObject<Effect> agony_resonance_effect = EFFECT.register("agony_resonance", () -> new AgonyResonanceEffect());
    public static final RegistryObject<Effect> been_resonated_effect = EFFECT.register("been_resonated", () -> new BeenResonatedEffect());
    public static final RegistryObject<Effect> curse_of_undead_effect = EFFECT.register("curse_of_undead", () -> new CurseOfUndeadEffect());
    public static final RegistryObject<Effect> let_me_savor_it_effect = EFFECT.register("let_me_savor_it", () -> new LetMeSavorItEffect());
    public static final RegistryObject<Effect> listen_to_me_singing_effect = EFFECT.register("listen_to_me_singing", () -> new ListenToMeSingingEffect());
    public static final RegistryObject<Effect> lightburn_fungal_infection_effect = EFFECT.register("lightburn_fungal_infection", () -> new LightburnFungalInfectionEffect());
    ...
    public static final RegistryObject<Effect> fresh_revenge_enchantment_active_effect = EFFECT.register("fresh_revenge_enchantment_active", () -> new BeneficialBlankImplicitEffect());
    public static final RegistryObject<Effect> miraculous_escape_encahntment_active_effect = EFFECT.register("miraculous_escape_encahntment_active", () -> new BeneficialBlankImplicitEffect());
    public static final RegistryObject<Effect> miraculous_escape_encahntment_force_escape_effect = EFFECT.register("miraculous_escape_encahntment_force_escape", () -> new MiraculousEscapeForceEscapeEffect());
    ...
    public static final RegistryObject<Effect> eyesore_enchantment_active_effect = EFFECT.register("eyesore_enchantment_active", () -> new EyesoreImplicitEffect());
