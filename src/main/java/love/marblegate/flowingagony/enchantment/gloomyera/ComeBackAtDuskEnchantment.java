...
public class ComeBackAtDuskEnchantment extends Enchantment {
    public ComeBackAtDuskEnchantment() {
        super(Rarity.RARE, EnchantmentCategory.ARMOR, EquipmentSlotTypeSet.ARMORS);
    }
    ...
    public boolean checkCompatibility(Enchantment p_77326_1_) {
        return super.checkCompatibility(p_77326_1_) && p_77326_1_ != EnchantmentRegistry.DIRTY_MONEY.get();
    }
