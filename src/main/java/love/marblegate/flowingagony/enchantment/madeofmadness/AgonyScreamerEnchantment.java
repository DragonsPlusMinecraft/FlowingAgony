...
public class AgonyScreamerEnchantment extends Enchantment {
    public AgonyScreamerEnchantment() {
        super(Rarity.VERY_RARE, EnchantmentCategory.BOW, EquipmentSlotTypeSet.MAIN_HAND);
    }
    ...
    public boolean checkCompatibility(Enchantment p_77326_1_) {
        return super.checkCompatibility(p_77326_1_) && p_77326_1_ != EnchantmentRegistry.INSANE_POET.get();
    }
