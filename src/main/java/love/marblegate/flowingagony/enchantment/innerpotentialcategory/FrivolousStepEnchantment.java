...
public class FrivolousStepEnchantment extends Enchantment {
    public FrivolousStepEnchantment(Rarity p_i46731_1_, EquipmentSlotType[] p_i46731_3_) {
    ...
    public boolean canApplyTogether(Enchantment p_77326_1_) {
        return super.canApplyTogether(p_77326_1_) && p_77326_1_ != EnchantmentRegistry.stubborn_step_enchantment.get();
    }
}
