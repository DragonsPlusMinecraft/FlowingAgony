...
public class MaliceOutbreakEnchantment extends Enchantment{
    ...
    @Override
    public boolean canVillagerTrade() { return Configuration.MALICE_OUTBREAK.get(); }

    @Override
    public boolean canGenerateInLoot() { return Configuration.MALICE_OUTBREAK.get(); }

    @Override
    public boolean isAllowedOnBooks() {
        return Configuration.MALICE_OUTBREAK.get();
    }

    @Override
    public boolean canApplyAtEnchantingTable(ItemStack stack) {
        if(Configuration.MALICE_OUTBREAK.get())
