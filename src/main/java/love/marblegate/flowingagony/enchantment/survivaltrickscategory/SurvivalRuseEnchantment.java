...
public class SurvivalRuseEnchantment extends Enchantment {
    ...
    public boolean checkCompatibility(Enchantment p_77326_1_) {
        return super.checkCompatibility(p_77326_1_) && p_77326_1_ != EnchantmentRegistry.SURVIVAL_SHORTCUT.get() && p_77326_1_ != EnchantmentRegistry.NECESSARY_EVIL.get();
    }

    @Override
    public boolean isTradeable() {
        return Configuration.AcquirableSetting.SURVIVAL_RUSE.get();
    }
    ...
    public boolean canApplyAtEnchantingTable(ItemStack stack) {
        if (Configuration.AcquirableSetting.SURVIVAL_RUSE.get())
