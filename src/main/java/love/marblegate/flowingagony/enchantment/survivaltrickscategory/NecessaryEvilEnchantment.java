...
public class NecessaryEvilEnchantment extends Enchantment {
    ...
    @Override
    public boolean canVillagerTrade() { return Configuration.NECESSARY_EVIL.get(); }

    @Override
    public boolean canGenerateInLoot() { return Configuration.NECESSARY_EVIL.get(); }

    @Override
    public boolean isAllowedOnBooks() {
        return Configuration.NECESSARY_EVIL.get();
    }

    @Override
    public boolean canApplyAtEnchantingTable(ItemStack stack) {
        if(Configuration.NECESSARY_EVIL.get())
